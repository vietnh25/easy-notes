...
public class SanPham {
	...
	Set<GallerySanPham>  gallerysanpham;
	
	
	
	public Set<GallerySanPham> getGallerysanpham() {
		return gallerysanpham;
	}
	public void setGallerysanpham(Set<GallerySanPham> gallerysanpham) {
		this.gallerysanpham = gallerysanpham;
	}
